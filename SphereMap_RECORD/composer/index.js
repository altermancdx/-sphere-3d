// ;Cube("datav:/com/@double11-2017/map3d-earth/0.1.14/composer", 
// ["datav:/npm/three/0.97.0", "datav:/npm/eventemitter3/2.0.3", "datav:/npm/safely-merge/1.0.1"], 
(function(a, b, c) {
  function d(a, b) {
      if (!(a instanceof b))
  ...
  var g = function() {
    ...
    , i = c("eventemitter3")
    , j = c("safely-merge")
    , k = c("../libs/effectLib/EffectComposer")
    , l = c("../libs/effectLib/RenderPass")
    , m = c("../libs/effectLib/CopyShader")
    , n = c("../libs/effectLib/ShaderPass")
    , o = c("../libs/effectLib/LuminosityHighPassShader")
    , p = c("../libs/effectLib/UnrealBloomPass")
    , q = c("../libs/effectLib/SMAAPass")
    , r = c("../libs/effectLib/TAARenderPass")
    , s = c("../libs/effectLib/FXAAShader")
    , t = c("../libs/effectLib/MaskPass")
    , u = c("../libs/effectLib/FilmPass")
    , v = c("../libs/effectLib/OutlinePass")
    , w = c("../libs/effectLib/SSAOShader")
    , x = {
      bloomThreshold: 0.8,
      bloomStrength: 1.8,
      bloomRadius: 0.3,
